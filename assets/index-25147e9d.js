...
`;$(G);$(U);$(me);de();ae();document.addEventListener("keydown",e=>{ue(e)});const F=document.getElementById("app");F!==null&&ge(F);console.log("Now impossible to get the 14-15 one!");
